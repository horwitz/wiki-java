...
public class ContributionSurveyor
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        if (parsedargs.containsKey("--zip"))
        {
            ...
            ContributionSurveyor.outputZipFile(new FileOutputStream(path.toFile()), zip);
        }
        else
        {
     ...
     *  @since 0.08
     */
    public static void outputZipFile(OutputStream os, Map<String, byte[]> output) throws IOException
    {
        try (ZipOutputStream zipper = new ZipOutputStream(os))
        {
