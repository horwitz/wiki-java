...
public class WikiTest
{
    ...
    public void getPageURL() throws Exception
    {
        ...
        assertEquals("https://ar.wikipedia.org/wiki/%D8%A7%D9%84%D8%B5%D9%81%D8%AD%D8%A9_%D8%A7%D9%84%D8%B1%D8%A6%D9%8A%D8%B3%D8%A9", 
            arWiki.getPageUrl("الصفحة الرئيسة"), "Unicode, RTL");
    }
    ...
    public void getPageProperties() throws Exception
    {
        ...
        pages.addAll(List.of("Main Page", "IPod", "Main_Page", "Special:Specialpages", "Portal talk:Massachusetts", "1&nbsp;000", "[invalid]"));
    ...
    public void getExternalLinksOnPages() throws Exception
    {
        ...
        List<String> expected = List.of("http://spam.example.com/", "http://www.example.net/",
            "https://example.com/protocol_relative", "https://domain.example/");
